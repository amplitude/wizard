/**
 * Sanitized bug report for the Bet 5 error-outro launchpad.
 *
 ...
 *
 * Intentionally small — detailed traces live in the diagnostic bundle
 * uploader (Bet 1 PR 3). This is the quick-copy companion.
 */
