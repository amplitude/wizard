...
// `selectModel` and the SDK fallback constants moved to
// `src/lib/agent/model-config.ts` (extracted in the stack-4 PR). See
// `src/lib/agent/__tests__/model-config.test.ts` for `selectModel`
// coverage and the `selectModel(...) !== FALLBACK_MODEL_*` invariant
// (BA-111) that pins the SDK's `fallbackModel !== model` requirement.
