...
export const COMMANDS = [
  ...
  { cmd: '/taxonomy', desc: 'Open the taxonomy agent for this project' },
  { cmd: '/chart', desc: 'Create your first Amplitude chart' },
  { cmd: '/dashboard', desc: 'Create your first Amplitude dashboard' },
