...
describe('logout command', () => {
  ...
  // logout (without --clean) deliberately does NOT touch project-scoped
  // artifacts — `wizard reset` (or `logout --clean`) is the gesture for
  // that. This test guards the separation: a debug-time logout should
  // NEVER nuke the user's setup report.
