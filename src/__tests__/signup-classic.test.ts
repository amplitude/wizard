...
describe('classic mode + --signup + direct signup integration', () => {
  ...
  it('on success, direct signup populates a real StoredUser and returns tokens', async () => {
    ...
    const session = buildSession({
      signup: true,
      signupEmail: 'grace@example.com',
      signupFullName: 'Grace Hopper',
    });
    ...
    expect(result!.accessToken).toBe('classic-access');
  });
