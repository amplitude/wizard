Never hallucinate an API key. Instead, always use the API key populated in the
.env file.
...
How Amplitude identifies users and whether events are identified have
significant billing consequences for an integration. Consult with the developer
before writing any code to implement or alter the approach to this task.
