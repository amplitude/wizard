...
<head>
  ...
  <meta content="The Kotlin Android SDK lets you send events to Amplitude.
Configure the SDK
  ...
  <script type="application/ld+json">
    {
      ...
      "@type": "Article",
      "headline": "Android",
      "description": "The Kotlin Android SDK lets you send events to Amplitude.
Configure the SDK

    Configuration",
      "url": "/docs/sdks/analytics/android",
      "publisher": {
        "@type": "Organization",
        "name": "Amplitude",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "/docs/sdks/analytics/android"
      },
      "author": [
        {
          "@type": "Organization",
...
<div class="box-border flex flex-row flex-nowrap items-center border-solid border-b border-black-200 h-12 px-4 justify-start"
  ...
  <amp-side-nav current-uri="/docs/sdks/analytics/android" nav-title="analytics_sdks">
    ...
    <span class="mr-2">/</span><div class="mr-2 text-s text-gray-500 "><a class="font-semibold"
        href="/docs/sdks/analytics/android">Android</a></div>
        ...
        <div class="copy">
            ...
            <div class="flex flex-wrap gap-4 w-full max-w-screen-xl">
                    ...
                    <div class="flex-1 basis-80 border border-amp-gray-200 grow-0 rounded p-4 hover:shadow transition">
                        ...
                        <a href="/docs/sdks/analytics/android/android-kotlin-sdk">
                            <h2 class="text-md font-Gellix my-0 flex flex-row content-center items-start">
                                
                                    <img class="h-6 rounded-sm inline mr-1 my-0" src="/docs/assets/icons/java.svg" />
                                
                                    <img class="h-6 rounded-sm inline mr-1 my-0" src="/docs/assets/icons/kotlin.svg" />
                                
                                <span class="ml-2">Android-Kotlin SDK</span>
                            </h2>
                        </a>
                        <div class="inline"><a href="https://mvnrepository.com/artifact/com.amplitude/analytics-android" target="_blank"><img class="my-0 inline"
                                    src="https://img.shields.io/maven-central/v/com.amplitude/analytics-android.svg?label=Maven%20Central" alt="" srcset="" /></a>
                        </div>
                        <ul class="text-sm">
                            <li><a href="https://github.com/amplitude/Amplitude-Kotlin" target="_blank">GitHub</a></li>
                            <li><a href="https://github.com/amplitude/Amplitude-Kotlin/releases" target="_blank">Releases</a></li>
                            
                                
                                    <li><a href="/docs/sdks/analytics/android/ampli-for-android-kotlin-sdk">Ampli</a></li>
                    ...
                    <div class="flex-1 basis-80 border border-amp-gray-200 grow-0 rounded p-4 hover:shadow transition">
                        ...
                        <a href="/docs/sdks/analytics/android/android-sdk">
                            <h2 class="text-md font-Gellix my-0 flex flex-row content-center items-start">
                                ...
                                <span class="ml-2">Android SDK</span>
                            </h2>
                        </a>
                        <div class="inline"><a href="https://mvnrepository.com/artifact/com.amplitude/android-sdk" target="_blank"><img class="my-0 inline"
                                    src="https://img.shields.io/maven-central/v/com.amplitude/android-sdk.svg?label=Maven%20Central&versionPrefix=2" alt="" srcset="" /></a>
                        </div>
                        <ul class="text-sm">
                            <li><a href="https://github.com/amplitude/Amplitude-Android" target="_blank">GitHub</a></li>
                            <li><a href="https://github.com/amplitude/Amplitude-Android/releases" target="_blank">Releases</a></li>
                            
                            
                                
                                    <li><a href="/docs/sdks/analytics/android/migrate-to-the-android-kotlin-sdk">Migrate to the Android-Kotlin SDK</a></li>
