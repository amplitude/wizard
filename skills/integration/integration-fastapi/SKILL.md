...
- Initialize Amplitude in the lifespan context manager on startup using the API key from environment variables
- Call await amplitude.flush() in the lifespan shutdown to ensure all events are sent before the app exits
