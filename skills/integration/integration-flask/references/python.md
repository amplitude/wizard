  ...
  <script type="application/ld+json">
{
    ...
    "headline": "Python",
    "description": "",
    "url": "/docs/sdks/analytics/python",
    "primaryImageOfPage": {
...
<div class="box-border flex flex-row flex-nowrap items-center border-solid border-b border-black-200 h-12 px-4 justify-start"
  ...
  <amp-side-nav current-uri="/docs/sdks/analytics/python" nav-title="analytics_sdks">
    ...
    <span class="mr-2">/</span><div class="mr-2 text-s text-gray-500 "><a class="font-semibold"
        href="/docs/sdks/analytics/python">Python</a></div>
        ...
        <div class="copy">
            ...
            <div class="flex flex-wrap gap-4 w-full max-w-screen-xl">
                    ...
                    <div class="flex-1 basis-80 border border-amp-gray-200 grow-0 rounded p-4 hover:shadow transition">
                        ...
                        <a href="/docs/sdks/analytics-sdks/python/python-sdk">
                            <h2 class="text-md font-Gellix my-0 flex flex-row content-center items-start">
                                
                                    <img class="h-6 rounded-sm inline mr-1 my-0" src="/docs/assets/icons/python.svg" />
                                
                                <span class="ml-2">Python SDK</span>
                            </h2>
                        </a>
                        <div class="inline"><a href="https://pypi.org/project/amplitude-analytics/" target="_blank"><img class="my-0 inline"
                                    src="https://badge.fury.io/py/amplitude-analytics.svg" alt="" srcset="" /></a>
                        </div>
                        <ul class="text-sm">
                            <li><a href="https://github.com/amplitude/Amplitude-Python" target="_blank">GitHub</a></li>
                            <li><a href="https://github.com/amplitude/Amplitude-Python/releases" target="_blank">Releases</a></li>
                            
                                
                                    <li><a href="/docs/sdks/analytics-sdks/python/ampli-for-python-sdk">Ampli</a></li>
