            ...
            <div class="flex items-center gap-2 mb-3">
                ...
                <h3 class="font-medium text-amp-gray-900 text-sm m-0">
                    <a href="https://npmjs.com/package/@amplitude/analytics-react-native" target="_blank">Package Information</a>
                        ...
                        <span class="ml-2 text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded" title="Fresh data (2026-03-24T17:10:31.170099Z)">Live</span>
            ...
            <div class="space-y-2.5">
                ...
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <div class="font-medium text-amp-gray-900">1.5.51</div>
                    </div>
                    <div class="text-right">
                        <div class="text-xs text-amp-gray-500 mb-1">Size (gzip)</div>
                        <div class="font-medium text-amp-gray-900">25.47 kB</div>
                    </div>
                </div>
            </div>
        </div>
