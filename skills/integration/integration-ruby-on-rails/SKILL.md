...
This skill helps you add Amplitude analytics to Ruby on Rails applications.
...
- Use the amplitude-api gem for Rails applications
- Initialize AmplitudeAPI with your API key in config/initializers/amplitude.rb
- Create a dedicated service class for Amplitude tracking to keep controllers clean
- Use background jobs for non-critical tracking to avoid slowing down requests
