...
This skill helps you add Amplitude analytics to Django applications.
...
- Use a singleton pattern for the Amplitude client — create it once and reuse it across requests
- Add amplitude.track() calls where meaningful user actions occur in views and API handlers
- For login/logout views, call amplitude.set_user_id() to associate events with identified users
