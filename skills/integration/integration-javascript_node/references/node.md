...
<div class="box-border flex flex-row flex-nowrap items-center border-solid border-b border-black-200 h-12 px-4 justify-start"
  ...
  <amp-side-nav current-uri="/docs/sdks/analytics/node" nav-title="analytics_sdks">
    ...
    <span class="mr-2">/</span><div class="mr-2 text-s text-gray-500 "><a class="font-semibold"
        href="/docs/sdks/analytics/node">Node.js</a></div>
        ...
        <div class="copy">
            ...
            <div class="flex flex-wrap gap-4 w-full max-w-screen-xl">
                    ...
                    <div class="flex-1 basis-80 border border-amp-gray-200 grow-0 rounded p-4 hover:shadow transition">
                        ...
                        <a href="/docs/sdks/analytics/node/node-js-sdk">
                            <h2 class="text-md font-Gellix my-0 flex flex-row content-center items-start">
                                
                                    <img class="h-6 rounded-sm inline mr-1 my-0" src="/docs/assets/icons/js.svg" />
                                
                                    <img class="h-6 rounded-sm inline mr-1 my-0" src="/docs/assets/icons/ts.svg" />
                                
                                <span class="ml-2">Node.js SDK</span>
                            </h2>
                        </a>
                        <div class="inline"><a href="https://www.npmjs.com/package/@amplitude/analytics-node" target="_blank"><img class="my-0 inline"
                                    src="https://img.shields.io/npm/v/@amplitude/analytics-node.svg" alt="" srcset="" /></a>
                        </div>
                        <ul class="text-sm">
                            <li><a href="https://github.com/amplitude/Amplitude-TypeScript/tree/v1.x/packages/analytics-node" target="_blank">GitHub</a></li>
                            <li><a href="https://github.com/amplitude/Amplitude-TypeScript/releases?q=analytics-node&expanded=true" target="_blank">Releases</a></li>
                            
                                
                                    <li><a href="/docs/sdks/analytics/node/ampli-for-node-sdk">Ampli</a></li>
                    ...
                    <div class="flex-1 basis-80 border border-amp-gray-200 grow-0 rounded p-4 hover:shadow transition">
                        ...
                        <a href="/docs/sdks/analytics/node/node-sdk">
                            <h2 class="text-md font-Gellix my-0 flex flex-row content-center items-start">
                                
                                    <img class="h-6 rounded-sm inline mr-1 my-0" src="/docs/assets/icons/js.svg" />
                                
                                <span class="ml-2">Node SDK</span>
                            </h2>
                        </a>
                        <div class="inline"><a href="https://www.npmjs.com/package/@amplitude/node" target="_blank"><img class="my-0 inline"
                                    src="https://img.shields.io/npm/v/@amplitude/node.svg" alt="" srcset="" /></a>
                        </div>
                        <ul class="text-sm">
                            <li><a href="https://github.com/amplitude/Amplitude-Node" target="_blank">GitHub</a></li>
                            <li><a href="https://github.com/amplitude/Amplitude-Node/releases" target="_blank">Releases</a></li>
                            
                                
                                    <li><a href="/docs/sdks/analytics/node/node-js-ampli-wrapper">Ampli</a></li>
                                
                            
                            
                                
                                    <li><a href="/docs/sdks/analytics/node/node-js-sdk-migration-guide">Node.js SDK Migration Guide</a></li>
