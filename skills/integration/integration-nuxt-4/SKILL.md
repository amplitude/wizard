...
description: Amplitude integration for Nuxt 4 applications
metadata:
  author: Amplitude
  version: dev
---

# Amplitude integration for Nuxt 4

This skill helps you add Amplitude analytics to Nuxt 4 applications.
