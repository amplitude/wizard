...
`NEW_MIGRATION_PLAN.md` got the strategic direction right (in-repo evolution, AI-SDK target, phased extraction). It is silent on four things that matter for execution:
